...
def actor_fn(input_queue, output_queue, seqlen=49, resize=240, crop_size=(240, 384)):
...
def dump_videos(dataset, anns, writer, vae, seqlen=49):
    ...
    img_args, batch_size = {"resize": 240, "crop_size": (240, 384)}, 4
